...
namespace MopBotTwo.Systems
{
	...
	public struct CurrencyAmount
	{
		...
		private static bool TryModifyForUser(ref CurrencyAmount[] currencyAmounts,SocketGuildUser user,out string givenString,Func<CurrencySystem.Currency,CurrencyAmount,ulong,ulong> func)
		{
		...
		private static void ModifyForUser(CurrencyAmount[] currencyAmounts,SocketGuildUser user,Func<CurrencySystem.Currency,CurrencyAmount,ulong,ulong> func)
		{
			if(currencyAmounts==null) {
			...
			var userId = user.Id;
			var currencies = user.Guild.GetMemory().GetData<CurrencySystem,CurrencySystem.CurrencyServerData>().Currencies;
		...
		public static CurrencyAmount[] ParseMultiple(string str,ServerMemory serverMemory) => ParseMultiple(str,serverMemory.GetData<CurrencySystem,CurrencySystem.CurrencyServerData>().Currencies);
		public static CurrencyAmount[] ParseMultiple(string str,BotIdCollection<CurrencySystem.Currency> currencies)
		{
