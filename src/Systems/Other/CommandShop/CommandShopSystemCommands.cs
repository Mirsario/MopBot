...
namespace MopBotTwo.Systems
{
	public partial class CommandShopSystem : BotSystem
	{
		...
		public async Task BuyItemCommand(string shopId,int itemId)
		{
			...
			//var currencyServerUserData = memory[context.user].GetData<CurrencySystem,CurrencySystem.CurrencyServerUserData>();
			var currencies = memory.GetData<CurrencySystem,CurrencySystem.CurrencyServerData>().Currencies;
		...
		public async Task ShowShopCommand(string shopId)
		{
			...
			var memory = server.GetMemory();
			var cmdShopServerData = memory.GetData<CommandShopSystem,CommandShopServerData>();
			var currencyServerData = memory.GetData<CurrencySystem,CurrencySystem.CurrencyServerData>();
