	...
	public partial class CommandSystem
	{
		...
		public async Task HelpCommand()
		{
			...
			var builder = MopBot.GetEmbedBuilder(context)
				...
				.WithFooter($"You can type {context.server.GetMemory().GetData<CommandSystem,CommandSystem.CommandServerData>().commandPrefix}help <command> to see groups' commands and commands' syntaxes.");
