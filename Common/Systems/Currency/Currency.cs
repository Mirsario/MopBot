...
namespace MopBot.Common.Systems.Currency
{
	...
	public class Currency
	{
		...
		[JsonProperty]
		private OrderedULongDictionary usersWealth; //Not storing in ServerUserData, since we need data sorted.

		[JsonIgnore]
		public OrderedULongDictionary UsersWealth => usersWealth ??= new OrderedULongDictionary();
